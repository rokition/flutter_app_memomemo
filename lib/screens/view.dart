...
import 'package:flutter_app_memomemo/screens/edit2.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          actions: <Widget>[
            ...
            IconButton(
              icon: const Icon(Icons.edit), // edit 버튼 누르면 아래 부분 실행됨.
              onPressed: () {
                Navigator.push(
                    context,
                    CupertinoPageRoute(
                        builder: (context) => EditPage2(id: widget.id))) .then((value) {setState(() {});});
              },
            )
          ],
        ),
